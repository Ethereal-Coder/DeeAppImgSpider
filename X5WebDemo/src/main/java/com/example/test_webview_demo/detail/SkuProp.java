...
public class SkuProp implements Parcelable {
  ...
  public static class ValueBean implements Parcelable {
    ...
    public static final Parcelable.Creator<ValueBean> CREATOR =
        new Parcelable.Creator<ValueBean>() {
  ...
  public static final Parcelable.Creator<SkuProp> CREATOR = new Parcelable.Creator<SkuProp>() {
